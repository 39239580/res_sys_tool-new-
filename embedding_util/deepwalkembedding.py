...
if __name__ == "__main__":
    params = {"format": "mat",
              "input": "./deepwalkdata/blogcatalog.mat",
              "output": "./deepwalkmodel/blogcatalog.embeddings",
    ...
    embedding2dict("./deepwalkmodel/blogcatalog.embeddings",
                   "./deepwalkmodel/blogcatalog.pkl")

    key_list = ["3197", "445"]  #
    result = get_deepwalkembedding("./deepwalkmodel/blogcatalog.pkl", set(key_list))
    print(result)
